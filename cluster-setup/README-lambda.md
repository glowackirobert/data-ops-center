...
The Lambda fetches GPS positions from the Gdansk public transport API 
and stores JSON-lines files in the S3 bucket `gdansk-public-transport` 
under `raw/YYYY/MM/DD/YYYY-MM-DD-HH-MM.txt`.
